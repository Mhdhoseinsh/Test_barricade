        ...
        (function() {
            ...
            const translations = {
                ...
                fa: {
                    ...
                    nameEntryTitle: 'برای شروع، اسم بازیکنان روت ۹ را وارد کنید',
            ...
            let selectedGameTypeOnline = localStorage.getItem('barricade-online-pref') === '1';
            let selectedTimerSeconds = parseInt(localStorage.getItem('barricade-timer-pref'), 10) || DEFAULT_TIMER_SECONDS;
            ...
            let classicSubMode = localStorage.getItem('barricade-mode-pref') === '4p' ? '4p' : '2p';
            ...
            document.getElementById('btn-pc-2').onclick = () => { switchClassicSubMode('2p'); localStorage.setItem('barricade-mode-pref', '2p') };
            document.getElementById('btn-pc-4').onclick = () => { switchClassicSubMode('4p'); localStorage.setItem('barricade-mode-pref', '4p') };
            ...
            document.getElementById('btn-gt-offline').onclick = () => { setGameType(!1); localStorage.setItem('barricade-online-pref', '0') };
            document.getElementById('btn-gt-online').onclick = () => { setGameType(!0); localStorage.setItem('barricade-online-pref', '1') };
            ...
            document.querySelectorAll('#timer-chip-group .timer-chip').forEach(chip => {
                chip.onclick = () => {
                    setSelectedTimer(parseInt(chip.dataset.secs, 10));
                    localStorage.setItem('barricade-timer-pref', selectedTimerSeconds)
                }
            });
            ...
            function showNameEntry(mode, isClassic) {
                ...
                document.getElementById('mode-select-view').style.display = 'none';
                document.getElementById('name-entry-view').style.display = 'block';
                setGameType(selectedGameTypeOnline);
        ...
        // Caches fonts/images on first visit (via sw.js) so later visits
        // skip re-downloading them and the site opens faster.
...
// ====== Yektanet native ads loader ======
!function(e,t,n){e.yektanetAnalyticsObject=n,e[n]=e[n]||function(){e[n].q.push(arguments)},e[n].q=e[n].q||[];var a=t.getElementsByTagName("head")[0],r=new Date,c="https://cdn.yektanet.com/superscript/x6fV5xRI/native-mhdhoseinsh.github.io-47969/yn_pub.js?v="+r.getFullYear().toString()+"0"+r.getMonth()+"0"+r.getDate()+"0"+r.getHours(),s=t.createElement("link");s.rel="preload",s.as="script",s.href=c,a.appendChild(s);var l=t.createElement("script");l.async=!0,l.src=c,a.appendChild(l)}(window,document,"yektanet");
